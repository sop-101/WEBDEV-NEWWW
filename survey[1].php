                ...
                <form method="POST" action="survey.php" id="surveyForm">
                    ...
                    <div class="section">
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Consuming at least 400 grams (roughly 5 servings) of fresh produce daily decreases individual risks for non-communicable chronic illnesses like hypertension and colorectal cancers.
                                <div class="reference">Reference: Devirgiliis, C., Guberti, E., Mistura, L., & Raffo, A. (2024). Effect of fruit and vegetable consumption on human health: An update of the literature. <a href="https://www.mdpi.com/2304-8158/13/19/3149" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Frequent intake of free liquid sugars spikes systemic glycemic loads, driving visceral fat accumulation and Type 2 Diabetes development.
                                <div class="reference">Reference: Malik, V. S., Popkin, B. M., Bray, G. A., Despr&eacute;s, J. P., Willett, W. C., & Hu, F. B. (2010). Sugar-sweetened beverages and risk of metabolic syndrome and type 2 diabetes: A meta-analysis. <em>Diabetes Care</em>, <em>33</em>(11), 2477&ndash;2483. <a href="https://doi.org/10.2337/dc10-1079" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Proper structural hydration ensures adequate renal clearance, cognitive focus, and safe cardiovascular volume stability.
                                <div class="reference">Reference: National Academies of Sciences, Engineering, and Medicine. (2005). <em>Dietary reference intakes for water, potassium, sodium, chloride, and sulfate</em>. The National Academies Press. <a href="https://doi.org/10.17226/10925" target="_blank">Link</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> The standard preventative baseline for global cardiovascular health is 150 minutes of moderate physical activity across the week.
                                <div class="reference">Reference: World Health Organization 2020 guidelines on physical activity and sedentary behaviour. <em>British Journal of Sports Medicine</em>. <a href="https://pubmed.ncbi.nlm.nih.gov/33239350/" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Consistently sleeping less than 6 hours disrupts immune capabilities, cognitive health, and triggers metabolic dysfunction.
                                <div class="reference">Reference: Hirshkowitz, M., et al. (2015). National Sleep Foundation's sleep time duration recommendations: methodology and results summary. <em>Sleep Health</em>, <em>1</em>(1), 40&ndash;43. <a href="https://doi.org/10.1016/j.sleh.2014.12.010" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Protracted periods of sitting generate high metabolic stagnation, slowing fat burning regardless of baseline exercise habits.
                                <div class="reference">Reference: Matthews, C. E., et al. (2012). Amount of time spent in sedentary behaviors and cause-specific mortality in US adults. <em>The American Journal of Clinical Nutrition</em>, <em>95</em>(2), 437&ndash;445. <a href="https://doi.org/10.3390/foods13193149" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Daily nicotine and tobacco usage introduces carcinogens and damages vascular tissue, drastically escalating chronic respiratory disease risks.
                                <div class="reference">Reference: WHO Framework Convention on Tobacco Control, World Health Organization Institutional Repository for Information Sharing (IRIS) 2003. <a href="https://iris.who.int/items/81d339dd-1df0-4b85-8cf1-7b862c40036a" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Excessive alcohol consumption increases hepatic stress, causes regular blood pressure spikes, and elevates long-term neurological risks.
                                <div class="reference">Reference: Centers for Disease Control and Prevention. (2022). <em>Dietary guidelines for alcohol</em>. U.S. Department of Health and Human Services. <a href="https://www.cdc.gov/alcohol/fact-sheets/dietary-guidelines.html" target="_blank">Link</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> This follows the validated clinical PHQ-2 protocol used by general practitioners to catch primary mental health stressors.
                                <div class="reference">Reference: Gelaye, B., et al. (2016). Diagnostic validity of the Patient Health Questionnaire-2 (PHQ-2) among Ethiopian adults. <em>Comprehensive Psychiatry</em>, <em>70</em>, 216&ndash;221. <a href="https://doi.org/10.1016/j.comppsych.2016.07.011" target="_blank">Link</a></div>
                            </div>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <div class="medical-rationale">
                                <strong>Medical Rationale:</strong> Early community-level biometric diagnostic monitoring flags asymptomatic conditions like hypertension before vascular complications appear.
                                <div class="reference">Reference: World Health Organization. (2020). <em>Package of essential noncommunicable (PEN) disease interventions for primary health care</em>. <a href="https://iris.who.int/handle/10665/342274" target="_blank">Link</a></div>
                            </div>
                        </div>
                    </div>
